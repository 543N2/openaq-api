...
function mochueloTest() {
    ...
    var mochueloSmoothData = movingAverage(mochueloRawData, AQI['pm25']['hours'])
    ...
    createConfig(mochueloLabels, mochueloRawData, 'raw', 'pm25')
    createConfig(mochueloLabels, mochueloSmoothData, 'smooth', 'pm25')
    plot(configRaw)
    plot(configSmooth)
}
// --------------------------------------------